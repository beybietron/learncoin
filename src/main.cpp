...
uint256 hashGenesisBlock("0x2a58d19e3ec5cbb70fc83120b345ff326aea0ef1522bb6517d617aabd6339519");
...
static const int64 nTargetTimespan = 5 * 60; // Learncoin:5 minutes
static const int64 nTargetSpacing = 30; // Learncoin: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2a58d19e3ec5cbb70fc83120b345ff326aea0ef1522bb6517d617aabd6339519");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is learncoin! Oh yeah!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xd74ba4733e28ee82600c4f7137ebbf07eacc48892c5344e6db64d048da458239"));
